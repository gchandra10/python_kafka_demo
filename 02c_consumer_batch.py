...
try:
    while True:
        ...
        batch = consumer.poll(timeout_ms=5000, max_records=500)  # Adjust these values as needed
    
        for batch_items in batch.items():
            tp,messages = batch_items
            for message in messages:
                ...
                print(
                    ...
                    \nMessage: {message_dict.get('type')},{message_dict.get('setup')},{message_dict.get('punchline')},{message_dict.get('id')}"
                )
